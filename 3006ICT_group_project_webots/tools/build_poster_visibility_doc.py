...
def write_doc(stations: dict[str, list[dict]]) -> None:
    ...
    lines = [
        ...
        "saturation/brightness heuristic (see `_measure_poster_bbox` in the capture block that",
        "produced this data) -- approximate, spot-checked against the `*_bbox.png` debug overlay",
        "saved alongside every frame.",
        "",
